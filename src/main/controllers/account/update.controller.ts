...
import { ValidationUpdateAccount } from '../validations/account/update';
import { AccountRequest } from '@ecommerce-backend/src/shared/types';
import { UpdateAccountService, UpdateAccountServiceImpl } from '@ecommerce-backend/src/domain/services/account/update';
...
export class UpdateAccountController {
    ...
    protected updateAccountService: UpdateAccountService<AccountRequest>;

    // * constructor
    constructor() {
        this.updateAccountService = Container.get(UpdateAccountServiceImpl);
    }
