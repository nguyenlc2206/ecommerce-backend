...
exports.ActiveAccountServiceImpl = void 0;
// * import libs
...
let ActiveAccountServiceImpl = class ActiveAccountServiceImpl {
    accountRepo;
    // * constructor
    constructor() {
    ...
    /** handle get account by id */
    hanleGetAccount = async (id) => {
        const response = await this.accountRepo.getById(id);
        if (!response)
            return (0, either_1.failure)(new appError_1.default('Not have account!', 400));
        return (0, either_1.success)(response);
    };
};
exports.ActiveAccountServiceImpl = ActiveAccountServiceImpl;
exports.ActiveAccountServiceImpl = ActiveAccountServiceImpl = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [])
], ActiveAccountServiceImpl);
