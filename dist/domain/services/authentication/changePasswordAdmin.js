...
exports.ChangePasswordAdminServiceImpl = void 0;
// * import libs
...
let ChangePasswordAdminServiceImpl = class ChangePasswordAdminServiceImpl {
    accountRepo;
    // * constructor
    constructor() {
    ...
    async execute(entity) {
        ...
        if (resultAccount.isFailure())
            return (0, either_1.failure)(resultAccount.error);
        // * check current password is correct
        const resultCheck = await this.handleCheckPasswordCorrect(entity?.body.passwordCurrent, resultAccount?.data?.password);
    ...
    handleGetAccountById = async (id) => {
        ...
        if (!response)
            return (0, either_1.failure)(new appError_1.default('Account is not exists!', 400));
...
exports.ChangePasswordAdminServiceImpl = ChangePasswordAdminServiceImpl;
exports.ChangePasswordAdminServiceImpl = ChangePasswordAdminServiceImpl = __decorate([
    (0, typedi_1.Service)(),
