...
exports.GetCategoryByIdServiceImpl = void 0;
// * import libs
...
let GetCategoryByIdServiceImpl = class GetCategoryByIdServiceImpl {
    categoryRepo;
    // * constructor
    constructor() {
    ...
    async execute(entity) {
        ...
        const result = _init.fromCategoryModel(resultGet.data);
    ...
    handleGetCategory = async (id) => {
        ...
        if (!response)
            return (0, either_1.failure)(new appError_1.default('Category is not already!', 400));
        return (0, either_1.success)(response);
    };
};
exports.GetCategoryByIdServiceImpl = GetCategoryByIdServiceImpl;
exports.GetCategoryByIdServiceImpl = GetCategoryByIdServiceImpl = __decorate([
    (0, typedi_1.Service)(),
