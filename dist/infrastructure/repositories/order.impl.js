...
let OrderRepositoryImpl = class OrderRepositoryImpl {
    ...
    async getById(id) {
        ...
        const result = await Order_1.default.findById(id).populate(popObj);
        return result;
    }
    ...
    async getAll() {
        ...
        const result = await Order_1.default.find().populate(popObj);
        return result;
    }
    ...
    async getByAccountId(id) {
        ...
        const result = await Order_1.default.find({ accountId: id }).populate(popObj);
        return result;
    }
};
