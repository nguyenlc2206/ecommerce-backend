...
exports.GetAllCouponController = void 0;
const typedi_1 = require("typedi");
// * import projects
const catchAsync_1 = __importDefault(require("../../../shared/common/catchAsync"));
const getAll_1 = require("../../../domain/services/coupon/getAll");
// ==============================||  GET ALL COUPON CONTROLLER ||============================== //
let GetAllCouponController = class GetAllCouponController {
    /** init services */
    getAllCouponService;
    // * constructor
    constructor() {
        this.getAllCouponService = typedi_1.Container.get(getAll_1.GetAllCouponServiceImpl);
    }
    /** execute method */
...
exports.GetAllCouponController = GetAllCouponController = __decorate([
    (0, typedi_1.Service)(),
