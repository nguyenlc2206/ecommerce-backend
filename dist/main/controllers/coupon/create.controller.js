...
const create_1 = require("../../../main/controllers/validations/coupon/create");
const create_2 = require("../../../domain/services/coupon/create");
// ==============================||  CREATE COUPON CONTROLLER ||============================== //
let CreateCouponController = class CreateCouponController {
    /** init services */
    validation = new create_1.ValidationCreateCoupon();
    createCouponService;
    /** constructor */
    constructor() {
        this.createCouponService = typedi_1.Container.get(create_2.CreateCouponServiceImpl);
    }
...
exports.CreateCouponController = CreateCouponController = __decorate([
    (0, typedi_1.Service)(),
