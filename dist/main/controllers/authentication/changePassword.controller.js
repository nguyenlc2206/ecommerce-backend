...
const changePassword_2 = require("../../../domain/services/authentication/changePassword");
...
let ChangePasswordController = class ChangePasswordController {
    ...
    // * constructor
    constructor() {
        this.changePasswordService = typedi_1.Container.get(changePassword_2.ChangePasswordServiceImpl);
    }
    // * execute method
