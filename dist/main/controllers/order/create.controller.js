...
const create_1 = require("../../../domain/services/order/create");
const create_2 = require("../../../main/controllers/validations/order/create");
// ==============================||  CREATE ORDER CONTROLLER ||============================== //
let CreateOrderController = class CreateOrderController {
    /** init validation */
    validation = new create_2.ValidationCreateOrder();
    createOrderService;
    // * constructor
    constructor() {
        this.createOrderService = typedi_1.Container.get(create_1.CreateOrderServiceImpl);
    }
    /** execute method */
