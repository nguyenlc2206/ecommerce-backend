...
const getAll_1 = require("../../../domain/services/order/getAll");
// ==============================||  GET ALL ORDER CONTROLLER ||============================== //
let GetAllOrderController = class GetAllOrderController {
    /** init services */
    getAllOrderService;
    // * constructor
    constructor() {
        this.getAllOrderService = typedi_1.Container.get(getAll_1.GetAllOrderServiceImpl);
    }
    /** execute method */
...
exports.GetAllOrderController = GetAllOrderController = __decorate([
    (0, typedi_1.Service)(),
