...
const delete_1 = require("../../../domain/services/order/delete");
// ==============================||  DELETE CATEGORY CONTROLLER ||============================== //
let DeleteOrderController = class DeleteOrderController {
    /** init services */
    deleteOrderService;
    // * constructor
    constructor() {
        this.deleteOrderService = typedi_1.Container.get(delete_1.DeleteOrderServiceImpl);
    }
    /** execute method */
...
exports.DeleteOrderController = DeleteOrderController = __decorate([
    (0, typedi_1.Service)(),
