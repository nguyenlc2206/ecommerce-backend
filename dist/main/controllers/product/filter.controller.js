...
let FilterProductsController = class FilterProductsController {
    /** init services */
    filterService;
    // * constructor
    constructor() {
        this.filterService = typedi_1.Container.get(filter_1.FilterServiceImpl);
    }
    /** execute method */
...
exports.FilterProductsController = FilterProductsController = __decorate([
    (0, typedi_1.Service)(),
