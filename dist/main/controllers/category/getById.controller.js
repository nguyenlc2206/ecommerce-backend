...
const getById_1 = require("../../../domain/services/category/getById");
// ==============================||  GET CATEGORY CONTROLLER ||============================== //
let GetCategoryByIdController = class GetCategoryByIdController {
    /** init services */
    getCategoryService;
    // * constructor
    constructor() {
        this.getCategoryService = typedi_1.Container.get(getById_1.GetCategoryByIdServiceImpl);
    }
    /** execute method */
...
exports.GetCategoryByIdController = GetCategoryByIdController = __decorate([
    (0, typedi_1.Service)(),
