...
exports.GetAccountMeController = void 0;
...
let GetAccountMeController = class GetAccountMeController {
    /** init services */
    getAccountMeService;
    // * constructor
    constructor() {
        this.getAccountMeService = typedi_1.Container.get(getMe_1.GetAccountMeServiceImpl);
    }
    /** execute method */
...
exports.GetAccountMeController = GetAccountMeController;
exports.GetAccountMeController = GetAccountMeController = __decorate([
    (0, typedi_1.Service)(),
