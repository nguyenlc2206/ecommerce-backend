...
exports.UpdateMeAccountController = void 0;
const typedi_1 = require("typedi");
// * import projects
const catchAsync_1 = __importDefault(require("../../../shared/common/catchAsync"));
const update_1 = require("../../../main/controllers/validations/account/update");
const updateMe_1 = require("../../../domain/services/account/updateMe");
// ==============================||  UPDATE ACCOUNT ME CONTROLLER ||============================== //
let UpdateMeAccountController = class UpdateMeAccountController {
    /** init service */
    validation = new update_1.ValidationUpdateAccount();
    updateAccountService;
    // * constructor
    constructor() {
        this.updateAccountService = typedi_1.Container.get(updateMe_1.UpdateAccountMeServiceImpl);
    }
    /** execute method */
...
exports.UpdateMeAccountController = UpdateMeAccountController;
exports.UpdateMeAccountController = UpdateMeAccountController = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [])
], UpdateMeAccountController);
